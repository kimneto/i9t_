...
Parse.Cloud.define("pega-trafegos", async (req) => {
   ...
   try {
       ...
       return {menssagem: "Lista de trafegos carregada com sucesso", data: resultTrafegos, sucesso: true, erro: null};
   } catch (e) {
       return {menssagem: "Erro ao listar trafegos", data: [], sucesso: false, erro: e.message};
   }
